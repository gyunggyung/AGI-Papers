...
title: Small Language Model for Translation
---
Small Language Model for Translation

Advice for AI engineers 💡

Language translation is a problem you can solve with a Small language model.

PS: If you don't speak Korean you can use this model to translate the post.
See this example ↓
...
이 약점들을 보완하기 위해 DPO 데이터셋 10,068쌍을 구축했습니다.

현재 Colab에서 DPO 학습 데이터 생성 중이며, 시간이 좀 걸릴 예정입니다.

DPO 이후에는 GRPO 강화학습을 다시 적용할 계획입니다.
