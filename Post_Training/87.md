...
Citizen of the world who teaches AI that works | Liquid AI | Maths Olympian

Who would have thought that 1.2B parameters are enough to build a top-notch English-to-Korean translation system 🇰🇷?

----
Wanna run it yourself?
Link to the example in the Liquid AI Cookbook -> https://lnkd.in/gEN-Bjf2
 ...
 * Step 1: SFT (Supervised Fine-tuning)
 10만 개의 고품질 한영 병렬 데이터셋으로 베이스를 다졌습니다. 이 과정에서 Maxime Labonne 님의 조언이 결정적이었습니다. 덕분에 베이스라인 대비 CHrF++ 점수를 4.3점 이상 끌어올렸습니다. (Special thanks to Maxime!)

 * Step 2: RL (Reinforcement Learning)
 SFT 모델을 기반으로 1만 개의 추가 데이터를 투입, GRPO(Generative Reinforcement Policy Optimization)를 적용하여 LoRA 어댑터를 훈련했습니다. 이를 통해 SFT 모델 대비 약 1.5점의 추가 성능 향상을 이끌어냈습니다.
